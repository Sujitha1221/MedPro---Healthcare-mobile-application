...
import com.example.medpro.BookAppointmentActivity
import com.example.medpro.R

class RecyclerViewLab(

    private val context: Context,
    private var resultTransaction: List<Lab>,
    private val activity: BookAppointmentActivity

) : RecyclerView.Adapter<RecyclerViewLab.ViewHolderTransaction>() {
        ...
        return when (viewType) {
            VIEW_TYPE_DATA -> {//inflates row layout
                val view = LayoutInflater.from(parent?.context)
                    .inflate(R.layout.all_lab_tests, parent, false)
    ...
    fun refreshAdapter(resultTransaction: List<Lab>) {
